 ...
 * `club.estadoCarga()` (ver constructor de `Landing`) leía `duracionElegida()` como signal DENTRO
 * de sus ramas. Angular trackea eso como dependencia del effect, así que un click de duración
